                ...
                <CContainer fluid>
                    <CRow className="align-items-stretch">
                        <CCol xs={12} md={6} style={styles.textCol}>
                            <h1 style={styles.heroTitle}>Customer Relationship Management</h1>
                            <h6 style={styles.heroDescription}>
                                Empower your team and delight your customers with our comprehensive
                                CRM solution. Streamline lead management, optimize sales processes,
                ...
                <CRow className="feature-cards" style={styles.featureCards}>
                    {[
                        ...
                        },
                        {
                            ...
                            description:
                                "Gain valuable insights with powerful analytics and customizable reports to drive data-informed decisions.",
                        },
                    ].map((feature, index) => (
