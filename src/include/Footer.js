                ...
                >
                    ...
                    <Box sx={{ display: "flex", gap: 4 }}>
                        ...
                        >
                            ...
                            <Link color={textColor} href="/products/fp-and-a-ml-ai" fontSize={18}>
                                FP&A Powered by ML and AI
                            </Link>
                            <Link color={textColor} href="/products/finsightpro" fontSize={18}>
                                FinSightPro
                            </Link>
                            <Link color={textColor} href="/products/datafusion" fontSize={18}>
                                DataFusion
                            </Link>
                            <Link color={textColor} href="/products/magic-excel" fontSize={18}>
                                Magic Excel
                            </Link>
                            <Link color={textColor} href="/products/crm" fontSize={18}>
                                CRM
                            </Link>
                        </Box>
                        <Box
